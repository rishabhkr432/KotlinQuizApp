...
//
//class QuestionPopup_cover : AppCompatActivity(){
...
//    private var creatingOptionsList: ArrayList<Int> = arrayListOf()
...
////                intent.putExtra(AddQuestion.QUESTION, question.text)
////                intent.putExtra(AddQuestion.SPINNER, spinnerSelectedText)
////                intent.putExtra(AddQuestion.OPTIONS, optionsNumber.text)
